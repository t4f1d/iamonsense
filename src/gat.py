...
"""https://github.com/tech-srl/how_attentive_are_gats/blob/main/gatv2_conv_DGL.py, https://github.com/tech-srl/how_attentive_are_gats"""
...
class GAT1(nn.Module):
    def __init__(self, in_feats, h_feats, num_classes, num_heads):
        ...
        self.layer1 = GATConv(in_feats, h_feats, num_heads=num_heads)
        # Be aware that the input dimension is h_feats*num_heads since
        # multiple head outputs are concatenated together. Also, only
        # one attention head in the output layer.
        self.layer2 = GATConv(h_feats * num_heads, h_feats, num_heads=1)
...
class GAT2(nn.Module):
    def __init__(self, in_feats, h_feats, num_classes, num_heads):
        ...
        self.layer1 = GATv2Conv(in_feats, h_feats, num_heads=num_heads)
        self.layer2 = GATv2Conv(h_feats * num_heads, h_feats, num_heads=1)
        self.classify = nn.Linear(h_feats, num_classes)
...
class GAT3(nn.Module):
    def __init__(self, in_feats, h_feats, num_classes, num_heads):
        ...
        self.layer1 = GATv2Conv(in_feats, h_feats*2, num_heads=1)
        self.layer2 = GATv2Conv(h_feats * 2, h_feats * num_heads, num_heads=1)
        self.layer3 = GATv2Conv(h_feats * num_heads, h_feats * num_heads, num_heads=1)
        self.layer4 = GATv2Conv(h_feats * num_heads, h_feats * 2, num_heads=1)
        self.layer5 = GATv2Conv(h_feats * 2, h_feats, num_heads=1)
        self.classify = nn.Linear(h_feats, num_classes)
...
class GAT4(nn.Module):
    def __init__(self, in_feats, h_feats, num_classes, num_heads):
        ...
        self.layer1 = GATv2Conv(in_feats, h_feats, num_heads=1)
        self.layer2 = GATv2Conv(h_feats, h_feats, num_heads=num_heads)
        self.layer3 = GATv2Conv(h_feats * num_heads, h_feats, num_heads=num_heads)
        self.layer4 = GATv2Conv(h_feats * num_heads, h_feats, num_heads=1)
        self.classify = nn.Linear(h_feats, num_classes)
...
class GCNGAT(nn.Module):
    def __init__(self, in_feats, h_feats, num_classes, num_heads):
        ...
        self.layer1 = GATv2Conv(h_feats, h_feats, num_heads=num_heads)
        self.conv2 = GraphConv(h_feats*3, h_feats)
        self.classify = nn.Linear(h_feats, num_classes)
...
class GCNGAT2(nn.Module):
    def __init__(self, in_feats, h_feats, num_classes, num_heads):
        super(GCNGAT2, self).__init__()
        self.conv1 = GraphConv(in_feats, h_feats)
        self.conv2 = GraphConv(h_feats, h_feats)
        self.layer1 = GATv2Conv(h_feats, h_feats, num_heads=num_heads)
        self.conv3 = GraphConv(h_feats*num_heads, h_feats)
        self.classify = nn.Linear(h_feats, num_classes)
